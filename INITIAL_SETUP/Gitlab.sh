...
echo ""
echo "    The \"--docker-volumes\" option may be unnecesary as we have already done this within "
echo "    \"podman run\" (stage 3)."
echo ""
echo "    Merely running \"podman exec -it gitlab-runner gitlab-runner register\"" 
echo "    and filling the details dynamically will suffice."
